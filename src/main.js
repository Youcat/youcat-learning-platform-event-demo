...
const copy = {
  en: {
    ...
    privacy: "Your name, age, and answer will be visible to people using this group code. Shared answers expire after about six hours.",
  ...
  pt: {
    ...
    privacy: "Seu nome, idade e resposta ficarão visíveis para quem usar este código de grupo. As respostas compartilhadas expiram após cerca de seis horas.",
